# App Store 등록 문구 — 스토리교회 Story App
...
| 연령 | 4+ |
| 가격 | 무료 |
| 개인정보 URL | https://sanfordstorychurch.com/privacy |
...
주보 — 이번 주 예배의 흐름(His · Your · Deep · Our Story), 설교 본문, 교회 소식, 기도 제목, 다음 주 예고를 한눈에. 지난 주보도 모아 봅니다.

말씀 노트 — 인쇄 주보의 말씀 노트와 같은 3단(His Story · My Story · Deep Story)으로 설교를 정리하고, 종이 주보 사진이나 손글씨를 붙여 두세요. 결단은 수요일에 다시 알려 드립니다.

성경 — 개역개정과 NIV. 책·장 이동, 절 형광, 북마크, 검색, 글자 크기 조절.

나눔 벽 — 오늘 받은 은혜와 기도 제목을 성도들과 나누고 "아멘"으로 함께합니다.

교회 — 예배 안내, 일정(내 캘린더에 추가), 모임, 헌금 안내. 한국어·영어 지원.

로그인은 이메일 코드 한 번으로 끝나며 비밀번호가 없습니다. 노트와 사진은 기기에만 저장되고, 로그인하면 노트 텍스트가 백업됩니다.

## Description (English)
The app for Sanford Story Church. God's story begins in your life.

Bulletin — This week's Story Flow (His · Your · Deep · Our Story), sermon passage, church news, prayer, and next week at a glance. Past bulletins are archived.

Sermon Notes — The same three-part note as the printed bulletin (His Story · My Story · Deep Story). Attach photos of your paper bulletin or handwriting. Your weekly commitment comes back as a Wednesday reminder.

Bible — Korean Revised Version and NIV. Book/chapter navigation, verse highlight, bookmarks, search, adjustable text size.

Story Wall — Share what you received today and prayer requests with the congregation, and respond with "Amen".

Church — Service info, events (add to your calendar), small groups, giving. Korean and English.

Sign in with a one-time email code, no password. Notes and photos stay on your device; signing in backs up your note text.

## 프로모션 텍스트 (170자)
샌포드 스토리교회 주보 · 말씀노트 · 성경 · 나눔을 한 앱에. 2026년 9월 27일 첫 예배와 함께 시작합니다.

## 새로운 기능 (v1.0.0)
첫 출시. 주보, 말씀 노트, 성경(개역개정·NIV), 나눔 벽, 교회 안내.
...
1. 01-bulletin.png — 주보 표지
2. 02-notes.png — 말씀 노트
3. 03-bible.png — 성경
4. 04-wall.png — 나눔 벽
5. 05-church.png — 교회
